  ...
  if (!kot) {
    return (
      <div className="section-container section-hero">
        <h1 className="heading-page mb-4">Kot nie został znaleziony</h1>
        <p className="text-body text-lg">Przepraszamy, nie możemy znaleźć tego kota.</p>
      </div>
    );
  }
