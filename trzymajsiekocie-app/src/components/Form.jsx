  ...
  const steps = [
    (
      <div className="animate-fadeIn" key={1}>
        <h2 className="text-lg font-bold text-orange-600 border-b pb-2 mb-4">I. Informacje podstawowe</h2>
    ...
    (
      <div className="animate-fadeIn" key={2}>
        <h2 className="text-lg font-bold text-orange-600 border-b pb-2 mb-4">II. Warunki mieszkaniowe i domownicy</h2>
    ...
    (
      <div className="animate-fadeIn" key={3}>
        <h2 className="text-lg font-bold text-orange-600 border-b pb-2 mb-4">III. Doświadczenie</h2>
    ...
    (
      <div className="animate-fadeIn" key={4}>
        <h2 className="text-lg font-bold text-orange-600 border-b pb-2 mb-4">IV. Bezpieczeństwo</h2>
    ...
    (
      <div className="animate-fadeIn" key={5}>
        <h2 className="text-lg font-bold text-orange-600 border-b pb-2 mb-4">V. Życie z kotem</h2>
